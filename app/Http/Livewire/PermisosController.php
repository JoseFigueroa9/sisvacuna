...
class PermisosController extends Component
{
    ...
    public $permissionName, $search, $componentName, $pageTitle, $selected_id;
    ...
    public function CreatePermission()
    {
        ...
        $messages = [ 
            ...
            'permissionName.min' => 'El nombre del permiso debe de tener al menos 3 caracteres' 
        ];
    ...
    public function UpdatePermission()
    {
        ...
        $messages = [ 
            'permissionName.required' => 'El nombre del permiso es requerido',
            'permissionName.unique' => 'El permiso ya existe',
            'permissionName.min' => 'El nombre permiso debe de tener al menos 3 caracteres' 
        ];
